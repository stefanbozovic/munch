...
<div class="container-md ">
  <div class="d-flex justify-content-between mb-5 mt-5">
    ...
    <div class="input-group flex-nowrap w-250">
      ...
      <input type="text" id="myInput" class="btn bg-light border pretaziborder" placeholder="Pretrazi proizvode" aria-describedby="addon-wrapping" onkeyup="pretraziProizvode()">
    </div>
